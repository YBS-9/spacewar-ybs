...
gravity_circle = c.create_oval(gravity_well_coords[0] - gravity_well_size, gravity_well_coords[1] + gravity_well_size,
                               ...
                               fill = '#0D0014', outline = 'white')

orange = c.create_polygon (orange_rotation_coords, fill = '#FF3200', outline = '#FFAA99')
...
green = c.create_polygon (green_rotation_coords, fill = '#B8FF00', outline = '#E2FF99')
...
orange_text = c.create_text(180, 50, font = ('Consolas', 20), fill = '#FF3200')
green_text = c.create_text(540, 50, font = ('Consolas', 20), fill = '#B8FF00')
...
def respawn():
    ...
    if orange_live_status == 0:
        ...
        if orange_respawn == 0:
            ...
            if rng == 1:
                ...
                orange_coords = [360, 695]
                orange_angle = 0
            elif rng == 3:
                orange_coords = [695, 695]
                orange_angle = 315
            elif rng == 4:
                orange_coords = [25, 360]
                orange_angle = 90
            else:
    ...
    if green_live_status == 0:
        ...
        if green_respawn == 0:
            ...
            if (rng2 == 1) and (rng2 != rng):
                green_coords = [25, 25]
                green_angle = 135
            elif rng2 == 2:
                green_coords = [695, 360]
                green_angle = 270
            elif (rng2 == 3) and (rng2 != rng):
                green_coords = [695, 695]
                green_angle = 315
            elif rng2 == 4:
                green_coords = [360, 25]
                green_angle = 180
